...
public class TestDb extends AndroidTestCase {
    ...
    public void testCreateDb() throws Throwable {
        ...
        Log.v(LOG_TAG, "testCreateDb call");
        ...
        do {
            tableNameHashSet.remove(c1.getString(0));
        } while( c1.moveToNext() );
        ...
        c1 = db.rawQuery("PRAGMA table_info(" + WeatherContract.LocationEntry.TABLE_NAME + ")",
                null);
        Cursor c2 = db.rawQuery("PRAGMA table_info(" + WeatherContract.WeatherEntry.TABLE_NAME + ")",
                null);
        ...
        int columnNameIndexLocation = c1.getColumnIndex("name");
        do {
            String columnName = c1.getString(columnNameIndexLocation);
            locationColumnHashSet.remove(columnName);
        } while(c1.moveToNext());

        int columnNameIndexWeather = c2.getColumnIndex("name");
        do {
            String columnName = c2.getString(columnNameIndexWeather);
